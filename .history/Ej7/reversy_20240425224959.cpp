...
void Reversy::print_tablero() {
    char horizontal_line[] = "\u2588\u2588"; // Carácter de bloque completo en Unicode
    char (*ptr1)[8] = tablero;
    ...
    for (int i = 0; i < 8; i++,ptr1++) {
        char *ptr2 = *ptr1;
        cout << "\033[1;31m" << horizontal_line << "\033[0m";
        ...
        cout  << "|" << "\033[1;31m" << horizontal_line << "\033[0m\n" 
         << "\033[1;31m" << horizontal_line << "\033[0m" << "_________________________________" << "\033[1;31m" << horizontal_line << "\033[0m\n";
    }
...
Reversy::Reversy(){
    ...
    for (; ptr_inicio < ptr_fin+1; ptr_inicio++) {
        *ptr_inicio = ' ';
    }
}
