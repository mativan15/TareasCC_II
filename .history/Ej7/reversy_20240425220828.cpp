...
void Reversy::imprimirCelda() {
    // Imprimir un borde superior de la celda
    std::cout << "\u250c\u2500\u2500\u2500\u2500\u2500";
    // Imprimir un borde derecho de la celda
    std::cout << "\u2510\n";
    
    // Imprimir un borde izquierdo de la celda
    std::cout << "\u2502        \u2502\n";
    
    // Imprimir un borde inferior de la celda
    std::cout << "\u2514\u2500\u2500\u2500\u2500\u2500";
    // Imprimir un borde derecho de la celda
    std::cout << "\u2518\n";
}
