...
void Reversy::colocarPieza(char pieza, int fila, int columna) {
    ...
    char *ptr2 = *(ptr1+fila);
    *(ptr2+columna) = pieza;
    cerr << "pieza "<< pieza<< " colocada en " << fila << columna << endl;
    cerr << "prueba en pos "<< tablero[fila][columna] << " \n "; 
}
...
void Reversy::checar_alrededor(char pieza, int fila, int columna) {
    ...
    for (int i=1; i <= llenar_izquierda; i++) { colocarPieza(pieza, fila-i, columna);}
...
int Reversy::checar_derecha(char pieza, int fila, int columna) {
    ...
    cout << endl <<"rellenar der" << rellenar << endl;
    return rellenar;
}
...
int Reversy::checar_abajo(char pieza, int fila, int columna) {
    ...
    cout << endl <<"rellenar aba" << rellenar << endl;
    return rellenar;
}
Reversy::Reversy(){
